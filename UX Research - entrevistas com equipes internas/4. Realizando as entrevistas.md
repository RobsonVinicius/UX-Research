...
## [Exercício] Por que criar personas?

Durante a pesquisas, nós criamos as personas e protopersona para termos documentadas as descobertas que fizemos durante a pesquisa.

Quais os benefícios de criarmos elas para o projeto da MusicDot?

- [ ] A) As personas e protopersonas ajudam a saber como cada pessoa pensa e age para facilitar as equipes de desenvolvimento a lembrarem das suas necessidades.<br>
    > Esses personagens são uma compilação de agrupamentos de características de pessoas. Por isso, não é possível obter informações precisas sobre cada pessoa.

- [ ] B) As personas e protopersonas ajudam pouco outras equipes, mas nós só estamos criando-as porque fica fácil compilar as informações que conseguimos.<br>
    > Na verdade, esses personagens ajudam muito tanto a equipe de UX quanto outras equipes relacionadas ao projeto da MusicDot. Tanto que existem pesquisas específicas apenas para a criação desses personagens.

- [x] C) As personas e protopersonas ajudam as equipes a identificarem necessidades das pessoas e lembrarem delas no processo de desenvolvimento.<br>
    > É mais fácil durante o processo de desenvolvimento você se lembrar da dor e necessidade de uma pessoa do que de um resultado de uma pesquisa. Nós nos relacionamos e criamos empatia por pessoas com mais facilidade, por isso, é um método de compilação de informações tão utilizado.

- [x] D) As personas e protopersonas ajudam a documentar e agrupar informações relevantes sobre as pessoas que estão relacionadas a um produto ou serviço.<br>
    > Esses personagens ajudam a identificar as necessidades que um determinado grupo de pessoas possui e o que é prioridade para eles, com a realização de pesquisas específicas apenas para eles.

<br>

## [Nota] Personas

Na apostila do curso presencial da Caelum também existe um [capítulo sobre personas](https://www.caelum.com.br/apostila-ux-usabilidade-mobile-web/personas/#os-sete-passos-para-criar-personas), disponível online. E  háum post no blog da Caelum sobre [entender o usuário usando proto-persona](https://blog.caelum.com.br/entendendo-usuario-proto-persona/).

No curso, a persona é apenas uma ferramenta auxiliar para sabermos e lembrarmos quem são as pessoas envolvidas com o projeto da MusicDot, e quem utiliza a plataforma. O processo de criação de personas necessita de uma pesquisa separada. Por isso, não estamos criando as personas no curso, e sim apresentando as personas criadas previamente.

[Os sete passos para criar Personas](https://www.caelum.com.br/apostila-ux-usabilidade-mobile-web/personas#os-sete-passos-para-criar-personas)
...
+ Apresentamos como foram as entrevistas realizadas com a equipe interna da MusicDot.
+ Agrupar as descobertas das entrevistas em personas e proto-persona.
=======
>>>>>>> 625e61c64e32e5b199cd5590297fe3fa374b2786
